...
class SubjectClassForm(forms.Form):
    """Form for selecting subjects for a class"""
    student_class = forms.ModelChoiceField(queryset=StudentClass.objects.all(), empty_label="Select a Class")
